...
const CategorySection = () => {
    ...
    return (
        ...
        Explore Our Best And <br /> Favorites{" "}
          <span className="text-yellow-500 underline"> Categories</span>
        </h2>
...
<div   style={{ backgroundImage: `url(${category.image})` }} className=" h-[295px] flex justify-center items-center w-full bg-cover bg-center cursor-pointer group ">
        <div className="absolute inset-0 bg-gradient-to-t from-black opacity-70"></div>
            <div className="absolute bottom-8  text-xl font-bold text-center flex flex-col gap-2 transition duration-300 text-white">{category.label}
