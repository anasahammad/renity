...
const Hero = () => {
    return (
      ...
      <div className="relative">
        ...
        />
        <span className="bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-lg absolute ml-6  top-10 -right-10">
          Sarah
        </span>
      </div>
    </div> */}
            {/* <div className="absolute top-1/3 right-20 transform translate-x-1/2">
                <img src="/path/to/profile2.jpg" alt="Kofi" className="w-16 h-16 rounded-full shadow-lg" />
            ...
            {/* <div className="absolute bottom-1/4 left-20 transform -translate-x-1/2">
                <img src="/path/to/profile3.jpg" alt="Root" className="w-16 h-16 rounded-full shadow-lg" />
            ...
            <div className="absolute bottom-1/4 right-10 transform translate-x-1/2">
                <img src="/path/to/profile4.jpg" alt="Burmah" className="w-16 h-16 rounded-full shadow-lg" />
                <span className="bg-blue-500 text-white text-xs font-bold px-2 py-1 rounded-full absolute top-0 right-0">Burmah</span>
            </div> */}

            {/* Hero Text */}
            <h1 className="text-5xl font-bold text-center mb-6">Find Your <span className="text-[#F8748C]">Scooter</span> <br /> <span>From People Near You</span></h1>
