            ...
            <div className="flex flex-col md:flex-row gap-4">
                ...
                {articles.map((article, index)=><div key={index} className="">
                    ...
                    <div className="grid gap-2 grid-cols-1 md:grid-cols-3 mt-16">
                        ...
                        <h3 className="group relative font-medium text-gray-500  text-sm cursor-pointer hover:text-[#F8748C]">By {article.author.name}
                    ...
                    <button className="relative group border  border-[#f8748c]  py-4 font-semibold w-52 overflow-hidden ">
                        <Link to="/"  className="w-full text-black group-hover:text-white z-50 px-14 transition-all duration-300  h-full py-4 ">Read More</Link>

                        <div className="w-20 group-hover:w-full absolute top-0 bottom-0  text-white bg-[#f8748c] h-full pl-4 py-4 group-hover:pl-36 clip-right-arrow group-hover:clip-none  z-0 transition-all duration-300"><FaArrowRight /></div>
                    </button>
                </div>)}
