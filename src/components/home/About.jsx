    ...
    <section className='flex flex-col md:flex-row items-center justify-center gap-6 p-6 md:p-16'>
      ...
      <div className='w-full md:w-1/2 pt-10'>
        ...
        <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold leading-tight mt-2'>
          Get The Best & The Most Used <span className='text-yellow-500'>Brands Equipments</span>
        </h2>
        <p className='my-4 sm:my-6 text-gray-600 text-sm sm:text-base'>Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum.</p>
        ...
        <div className='flex flex-col sm:flex-row gap-4 sm:gap-8 mt-8'>
          <div className='border-r-0 sm:border-r-2 pr-0 sm:pr-8 text-center sm:text-left'>
            <h3 className='text-3xl sm:text-4xl md:text-5xl font-bold text-yellow-500'>15+</h3>
            <p className='text-gray-500 text-sm sm:text-base'>Years in Business</p>
          </div>
          <div className='border-r-0 sm:border-r-2 pr-0 sm:pr-8 text-center sm:text-left'>
            <h3 className='text-3xl sm:text-4xl md:text-5xl font-bold text-green-500'>3K+</h3>
            <p className='text-gray-500 text-sm sm:text-base'>Jobs Done</p>
          </div>
          <div className='text-center sm:text-left'>
            <h3 className='text-3xl sm:text-4xl md:text-5xl font-bold text-blue-500'>1.2M</h3>
