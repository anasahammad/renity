    ...
    <div className='relative bg-[#FFF9EC] h-full py-20 flex flex-col items-center justify-center border-t'>
      ...
      <div className='bg-white shadow-lg flex flex-col md:flex-row items-center px-4 gap-4 w-[85%] py-4 md:h-24 z-10'>
        ...
        <motion.select
          ...
          className='border pl-4 w-full text-gray-700 md:flex-1 h-12 md:h-18 focus:outline-none'
        ...
        >
          <option value={''}>{translations.heroSearchingLoc}</option>
        ...
        <button
          ...
          className='bg-yellow-500 text-white font-bold text-[18px] px-4 h-12 w-full md:h-18 md:flex-1 flex items-center gap-2 justify-center'
        >
