        ...
        {articles.map((article, index) => (
          ...
          >
            <div className='relative'>
              ...
              <div className='absolute -bottom-5 left-12 bg-[#F9C247] text-white w-16 h-16 text-xl font-semibold text-center '>{article.date}</div>
            </div>
            ...
            <button className='relative group border  border-[#f8748c]  py-4 font-semibold w-52 overflow-hidden '>
              <Link
                to='/'
                className='w-full text-black group-hover:text-white z-50 px-14 transition-all duration-300  h-full py-4 '
              >
                Read More
              </Link>
