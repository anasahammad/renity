    ...
    <div className='flex justify-center items-center h-screen'>
      <div className='bg-white shadow-lg rounded-2xl w-3/5'>
        ...
        <div className='flex flex-col items-center justify-center p-4 -mt-16'>
          ...
          <p className='p-2  px-4 text-xs text-white bg-[#FF4D30] rounded-full'>{role.charAt(0).toUpperCase() + role.slice(1)}</p>
          <p className='mt-2 text-xl font-medium text-gray-800 '>User Id: #004jd</p>
          <div className='w-full p-2 mt-4 rounded-lg'>
            <div className='flex flex-wrap items-center justify-between text-sm text-gray-600 '>
              <p className='flex flex-col'>
                Name
                <span className='font-bold text-black '>Anas Ahammad Sarker</span>
              </p>
              <p className='flex flex-col'>
                Email
