...
const Catalog = () => {
    ...
    const [priceRange, setPriceRange] = useState([5.00, 230.00])
    ...
    return (
      ...
      <div className="w-80 p-6 bg-[#FBFAF3] border-r">
        {/* Price Filter */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4 relative">Price
        ...
        {/* Category Filter */}
        <div className="mb-8">
          <h3 className="text-xl  font-semibold mb-4 relative">Category
        ...
        {/* Kit Type */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4 relative">Kit Type
          <span className="absolute -bottom-1 left-0 h-1 w-20 bg-yellow-400"></span>
          </h3>
        ...
        {/* Extra Items */}
        <div className="mb-8">
          <h3 className="text-xl relative font-semibold mb-4">Extra Items
        ...
        <button className="w-full bg-[#f8748c] text-white py-4  ">
          APPLY FILTERS
        </button>
      </div>
